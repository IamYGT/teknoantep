...
<title><?=$oku->blog_kat_adi?></title>
<meta name="keywords" content="<?=$oku->blog_kat_meta?>" />
<meta name="description" content="<?=$oku->blog_kat_desc?>">
        ...
        <div class="row">
            <div class="col-xl-12">
                <div class="inner-content clearfix">
                    <div class="title">
                       <h1><i class="fa fa-newspaper-o" aria-hidden="true"></i> <?=$oku->blog_kat_adi?></h1>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-xl-8 col-lg-7 col-md-12 col-sm-12">
                <div class="blog-post">
                    <?php
					$limit = 5;
					$sql_text = "SELECT * FROM dbo_blog WHERE blog_kat_id = '".$duzenid."' ORDER BY BlogID DESC";
