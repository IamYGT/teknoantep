	...
	<div class="limiter">
		<div class="container-login100">
			...
			<div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50">
                <form id="lgfrm" class="login100-form validate-form" action="" method="" onsubmit="return false">
					...
					<div class="wrap-input100 validate-input" data-validate = "Valid email is required: ex@abc.xyz">
						...
						<input class="input100" type="text" name="email" placeholder="Geçerli Bir Mail Adresi Girin!">
					...
					<div class="container-login100-form-btn" style="width:100%;">
						<div class="wrap-login100-form-btn" style="width:100%;">
							...
							<button id="lgbtn" type="submit" class="login100-form-btn" style="width:100%;">
								Giriş Yap
							</button>
						</div>
					</div>
				</form>
                <div id="sonuc" class="col-lg-12" style="margin-top:15px;"></div>
			</div>
		</div>
	</div>
