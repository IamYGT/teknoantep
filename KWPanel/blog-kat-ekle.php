...
$isle = $db->table('dbo_blog_kat')->insert($data);

	if($isle){
		$bilgi = alert('success','Kategori Eklendi','blog-kat-liste.html',3);
		}else{
		$bilgi = alert('danger','Kategori Eklenemedi!','blog-kat-liste.html',3);
	}
...
<link href="css/separate/vendor/tags_editor.min.css" rel='stylesheet' type='text/css'>
	...
	<div class="page-content">
		<header class="page-content-header">
			<div class="container-fluid">
				<div class="tbl">
					<div class="tbl-row">
						<div class="tbl-cell">
							<h3><small class="text-muted">Kategori Ekleme İşlemi</small></h3>
						</div>
		...
		<div class="container-fluid">
        <?=@$bilgi?>
        <form id="form_validation" method="POST" action="blog-kat-ekle.html" enctype="multipart/form-data">
			<div class="col-lg-6">
                <section class="card">
