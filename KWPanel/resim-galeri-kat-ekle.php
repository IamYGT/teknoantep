...
$isle = $db->table('dbo_resim_galeri_kat')->insert($data);

	if($isle){
		$bilgi = alert('success','Kategori Eklendi','resim-galeri-kat.html',3);
		}else{
		$bilgi = alert('danger','Kategori Eklenemedi!','resim-galeri-kat.html',3);
	}
...
<link href="css/separate/vendor/tags_editor.min.css" rel='stylesheet' type='text/css'>
	...
	<div class="page-content">
		...
		<div class="container-fluid">
        <?=@$bilgi?>
        <form id="form_validation" method="POST" action="resim-galeri-kat-ekle.html" enctype="multipart/form-data">
			<div class="col-lg-6">
                <section class="card">
