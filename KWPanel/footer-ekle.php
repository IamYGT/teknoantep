...
$isle = $db->table('dbo_footer_link')->insert($data);

	if($isle){
		$bilgi = alert('success','Link Eklendi','footer-ekle.html',3);
		}else{
		$bilgi = alert('danger','Link Eklenemedi!','footer-ekle.html',3);
	}
...
<link href="css/separate/vendor/tags_editor.min.css" rel='stylesheet' type='text/css'>
	...
	<div class="page-content">
		<header class="page-content-header">
			<div class="container-fluid">
				<div class="tbl">
					<div class="tbl-row">
						<div class="tbl-cell">
							<h3><small class="text-muted">Link Ekleme</small></h3>
						</div>
		...
		<div class="container-fluid">
        <?=@$bilgi?>
        <form id="form_validation" method="POST" action="footer-ekle.html" enctype="multipart/form-data">
			<div class="col-lg-6">
                <section class="card">
                    ...
                    <div class="card-block">
                        <fieldset class="form-group">
                            ...
                            <input type="text" name="fo_adi" class="form-control" required>
                        </fieldset>
                        <fieldset class="form-group">
                            <label class="form-label">Link URL</label>
                            <input type="text" name="fo_link" class="form-control" required>
                        </fieldset>
                    </div>
                </section>
            </div>
