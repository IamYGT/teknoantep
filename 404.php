  ...
  <head>
    ...
    <style class="cp-pen-styles">
      ...
      body {
        ...
        overflow: hidden;
		background:url(https://i.ytimg.com/vi/tDKU1YikgGo/maxresdefault.jpg);
  ...
  <body>
    <div class="main">
      <div id='content'>
        ...
        <p>Aradığınız İçeriğe Ulaşamadık :(</p>
        <p>Yaşadığınız sorundan dolayı özür dileriz, lütfen menülerden herhangi bir bağlantı seçiniz.</p>
      </div>
    </div>
